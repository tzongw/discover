...
_LOGIN = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      has_default_value=True, default_value=_b("user:login").decode('utf-8'),
...
_LOGOUT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=True, default_value=_b("user:logout").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
...
_ALARM = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=True, default_value=_b("user:alarm").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(

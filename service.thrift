...
service user {
    ...
    oneway void recv_binary(1: string address, 2: string conn_id, 3: string context, 4: binary message)
    oneway void recv_text(1: string address, 2: string conn_id, 3: string context, 4: string message)
}